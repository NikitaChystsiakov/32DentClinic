...
export const legalDocuments: LegalDocument[] = [
  ...
  },
  {
    ...
    description:
      'Какие cookie использует сайт, зачем, сколько хранятся, куда передаются. Сейчас сайт не ставит cookie вовсе; в localStorage браузера хранится только выбранная тема (светлая/тёмная) — это техническая настройка, согласия не требует. Карта Яндекса загружается по кнопке и ставит свои cookie только после клика. Если подключите аналитику или рекламные пиксели — понадобится баннер согласия, см. docs/ГДЕ-ЧТО-МЕНЯТЬ.md.',
    files: {},
  },
]
