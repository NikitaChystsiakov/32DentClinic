...
export const nearbyTowns: NearbyTown[] = [
  ...
  },
  {
    ...
    // Расстояния — от центра до центра по дорогам (nakarte.by, avtodispetcher,
    // проверено 17.09.2026): в Жлобин — выезд по Р-43 (ул. Урицкого) и дальше
    // по М-5/Е271, 66–67 км, 52–59 мин; в Рогачёв — по дороге через Большие
    // Бортники и Дворец, 58 км, ~50 мин. На машине Рогачёв даже чуть ближе,
    // но Жлобин — первый: с ним у Бобруйска прямая железная дорога (16
    // региональных поездов в день, 38–56 мин, клиника в 200 м от вокзала),
    // там принимает хирург-имплантолог и работает онлайн-запись. Страница
    // об этом говорит честно и не прячет Рогачёв.
    clinics: [
      { slug: 'zhlobin', distanceKm: 66, travelMinutes: 55 },
      { slug: 'rogachev', distanceKm: 58, travelMinutes: 50 },
    ],
  },
  {
    slug: 'bykhov',
    ...
    nameIn: 'Быхове',
    nameFrom: 'Быхова',
    // Быхов — райцентр Могилёвской области на Днепре, 50 км от Могилёва;
    // Рогачёв для него — ближайший город с клиникой сети.
    region: 'Могилёвская область',
    coordinates: { lat: 53.5261, lng: 30.2358 },
    // Расстояния — от центра до центра по дорогам: в Рогачёв по Р-97
    // «Могилёв — Быхов — Рогачёв» (сервисы маршрутов дают 59–61 км и
    // 50–60 мин), в Жлобин — дальше по той же дороге через Рогачёв (86 км,
    // ~1 ч 25 мин). Проверено 17.09.2026. Рогачёв — первый: он ближе, а
    // Жлобин — на 25 км дальше по той же трассе, там хирург-имплантолог и
    // онлайн-запись.
    clinics: [
      { slug: 'rogachev', distanceKm: 60, travelMinutes: 55 },
      { slug: 'zhlobin', distanceKm: 85, travelMinutes: 85 },
    ],
  },
]
