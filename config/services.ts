...
export const serviceCategories: ServiceCategory[] = [
  ...
  },
  {
    ...
    icon: 'Microscope',
    procedures: [
      { name: 'Консультация с осмотром под микроскопом', priceFrom: 30 },
      { name: 'Лечение кариеса под микроскопом', priceFrom: 120 },
      { name: 'Лечение каналов под микроскопом (1 канал)', priceFrom: 180 },
      { name: 'Перелечивание каналов под микроскопом (1 канал)', priceFrom: 250 },
      { name: 'Извлечение отломка инструмента из канала', priceFrom: 200 },
    ],
    whenToVisit: [
