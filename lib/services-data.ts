...
//
// ВНИМАНИЕ: это копия config/services.ts без поля `availableIn`. Страницы
// городов читают config/services.ts, а прайс, калькулятор и форма записи —
// этот файл. При смене цены или названия процедуры правьте оба файла.
// Цены — в белорусских рублях, число без «BYN».
